...
public:
	...
	enum I_COLORS{  // Item Colors
        KAPALI     = RED, //D3DCOLOR_ARGB(255,255,255,255),
        ACIK     =  D3DCOLOR_ARGB(255, 124, 252, 0),// D3DCOLOR_ARGB(191,255,0,0),
	...
	enum BK_COLORS{ // BackGround Colors
        ...
        C_BORDER = D3DCOLOR_ARGB(255, 225, 0, 0),// D3DCOLOR_ARGB(161,226,255,0)
    };
	enum I_TYPES{
        YAZI = 0,
        SECENEK = 1,
